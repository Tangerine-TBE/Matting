package com.abc.matting.utils.camera
    ...
    private fun startCaptureSession() {
        ...
        try {
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
                cameraInstance?.createCaptureSession(SessionConfiguration(
                    SessionConfiguration.SESSION_REGULAR,
                    arrayListOf(OutputConfiguration(imageReader!!.surface)),
                    BaseApplication.application.mainExecutor,
