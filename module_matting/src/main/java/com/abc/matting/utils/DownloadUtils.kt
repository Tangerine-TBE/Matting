...
import com.feisukj.base.util.LogUtils.i
import okhttp3.*
import java.io.File
...
//    }
    ...
    fun downloadFile(url: String, filePath: String, callback: RequestCallback) {
        ...
        i("DOWNLOAD", "startTime=$startTime")
...
//                    listener.onDownloadSuccess();
                    ...
                    i("DOWNLOAD", "download success")
                    i("DOWNLOAD", "totalTime=" + (System.currentTimeMillis() - startTime))
