...
public class UpperBodyClothColor extends AbstractModel{
    ...
    */
    ...
    /**
     * Get 上衣颜色信息，返回值为以下集合中的一个 {红色系, 黄色系, 绿色系, 蓝色系, 黑色系, 灰白色系。 
    ...
    /**
     * Set 上衣颜色信息，返回值为以下集合中的一个 {红色系, 黄色系, 绿色系, 蓝色系, 黑色系, 灰白色系。
     ...
     */
    public UpperBodyClothColor(UpperBodyClothColor source) {
        if (source.Type != null) {
