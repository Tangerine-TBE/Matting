...
class SexActivity : BaseActivity(), SelectSexDialog.SelectSexCallback {
    companion object {
    ...
    private var type = "sex"
    private lateinit var dialog: SelectSexDialog
    private var canInitCamera = true

    override fun getLayoutId(): Int = R.layout.activity_sex
...
//                    .freeStyleCropEnabled(true)
    ...
    private fun initCamera2() {
        ...
        mImageReader = ImageReader.newInstance(textureView.width, textureView.height, ImageFormat.YUV_420_888, 1)
        ...
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
                mCameraDevice?.createCaptureSession(SessionConfiguration(SessionConfiguration.SESSION_REGULAR,
                    arrayListOf(OutputConfiguration(surface)),this.mainExecutor,object : CameraCaptureSession.StateCallback() {
