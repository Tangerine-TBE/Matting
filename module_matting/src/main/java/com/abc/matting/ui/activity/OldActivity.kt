...
class OldActivity : BaseActivity(), SelectAgeDialog.SelectAgeCallback {
    ...
    private lateinit var dialog: SelectAgeDialog
    private var type = "old"
    private var canInitCamera = true

    override fun getLayoutId(): Int = R.layout.activity_old
...
//                    .freeStyleCropEnabled(true)
    ...
    private fun initCamera2() {
        visible(album,shutter,transition)
        invisible(over,test)
        canInitCamera = true
