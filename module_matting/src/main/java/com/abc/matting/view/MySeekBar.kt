...
class MySeekBar @JvmOverloads constructor(
    ...
    init {
        icon = BitmapUtils.getBitmap(context,R.drawable.ic_slider,DeviceUtils.dp2px(context,30f),DeviceUtils.dp2px(context,30f))
        paint?.apply {
            this.color = Color.parseColor("#FFD23D")
        ...
        sliderTextPaint.apply {
            this.color = Color.parseColor("#272727")
            this.textSize = 40f
            this.isAntiAlias = true
            this.textAlign = Paint.Align.CENTER
        }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        paint.color = Color.parseColor("#FFD23D")
