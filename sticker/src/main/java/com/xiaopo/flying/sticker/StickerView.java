...
public class StickerView extends FrameLayout {
  ...
  public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    try {
      ...
      borderPaint.setColor(a.getColor(R.styleable.StickerView_borderColor, Color.parseColor("#FFD23D")));
  ...
  public void save(String fileDir,String fileName,boolean toGallery){
    BitmapUtils.saveImageToGallery(createBitmap(),fileDir,fileName,toGallery);
  }
