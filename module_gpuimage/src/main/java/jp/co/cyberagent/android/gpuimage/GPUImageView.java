...
public class GPUImageView extends FrameLayout {
     ...
     */
    public void saveToPictures(final String fileDir,final String fileName,
                               final OnPictureSavedListener listener) {
        new SaveTask(fileDir,fileName, listener).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
    ...
    public void saveToPictures(final String fileDir, final String fileName,
                               ...
                               final OnPictureSavedListener listener) {
        new SaveTask(fileDir,fileName, width, height, listener).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
    ...
    private class SaveTask extends AsyncTask<Void, Void, Void> {
        ...
        public SaveTask(final String fileDir, final String fileName,
                        final OnPictureSavedListener listener) {
            this(fileDir,fileName, 0, 0, listener);
        }

        public SaveTask(final String fileDir, final String fileName, int width, int height,
                        final OnPictureSavedListener listener) {
        ...
        protected Void doInBackground(final Void... params) {
            try {
                ...
                saveImage(fileDir,fileName, result);
        ...
        private void saveImage(final String fileDir, final String fileName, final Bitmap image) {
